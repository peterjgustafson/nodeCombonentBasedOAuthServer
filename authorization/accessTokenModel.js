...
function getAccessToken(bearerToken, callback, component = null) {

  console.log("component: ", component);

  //try and get the userID from the db using the bearerToken
  accessTokensDBHelper.getUserIDFromBearerToken(bearerToken, (userID, companyID) => {
    console.log(userID)
    ...
    if(component)
      accessToken.authorizedResource = component;
